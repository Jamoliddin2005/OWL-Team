...
function Dashboard({ toggle, setWithdrawalToggle, GetUrl, account }) {
        ...
        <div className={`row ${classes.row}`}>
          <div className={classes.dashboardLeft}>
            <div className={classes.dashboardLeftTop}>
              <h2>
                Good day,{" "}
                <span>{account.username ? account.username : "..."}</span>
              </h2>
            ...
            <div className={classes.dashboardStolen}>
              <div className={classes.stolen}>
                <div className={classes.stolenLeft}>
                  <h3>{account.walletStolen ? account.walletStolen : 0}</h3>
              ...
              <div className={classes.stolen}>
                <div className={classes.stolenLeft}>
                  <h3>{account.tokenStolen ? account.tokenStolen : 0}</h3>
              ...
              <div className={classes.stolen}>
                <div className={classes.stolenLeft}>
                  <h3>{account.nftStolen ? account.nftStolen : 0}</h3>
            ...
            <div className={classes.lastLogs}>
              <div className={classes.logs_top}>
                <h4>Last Withdrawal Requests</h4>
                <Link to={"/logs"}></Link>
              </div>
              ...
              <div
                className={`${classes.products} ${
                  withdrawalsLoading && classes.loadingBig
                }`}
              >
                {withdrawalsLoading ? (
                  <Loading size={0.65} />
                    ...
                    <div className={classes.product} key={index}>
                      ...
                      <div className={classes.button}>
                        {item.status === "Completed" ? (
                          ...
                          <button className={classes.waiting}>
                            {item.status}
                          </button>
                        )}
                      </div>
            ...
            <div className={classes.RightBalance}>
              ...
              <div className={classes.balanceBottom}>
                <div className={classes.leftB}>
                  ...
                  <h2>$ {account.incomeAllTime ? account.incomeAllTime : 0}</h2>
                </div>
            ...
            <div className={classes.transactions}>
              ...
              <div
                className={`${classes.transactionsItem} ${
                  transactionsLoading && classes.loadingBig
                }`}
              >
                {transactionsLoading ? (
                  <Loading size={0.3} />
